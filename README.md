...
**RoR- Blog** This project was develop to test my skills un ruby on rails and ORM.
...
```sh
  ...
  git clone https://github.com/NelsonAraujo93/RoR-Blog.git
```
...
Feel free to check the [issues page](https://github.com/NelsonAraujo93/issues).
