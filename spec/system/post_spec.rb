...
RSpec.describe Post, type: :system do
  ...
  let(:first_post) { Post.new(author: user, title: 'This is a title', likes_counter: 0, comments_counter: 0) }
  let(:second_post) { Post.new(author: user, title: 'This is a title', likes_counter: 0, comments_counter: 0) }
  let(:third_post) { Post.new(author: user, title: 'This is a title', likes_counter: 0, comments_counter: 0) }
  ...
  describe 'index page' do
    ...
    it 'redirects from post#index to post#show' do
      visit "/users/#{user.id}/posts"
      find("#test-#{subject.id}", text: subject.title).click
